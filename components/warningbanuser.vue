<template>
  <div class="overlay-delete">
    <v-col v-if="this.banned === false" class="d-flex justify-center align-center">
      <v-card class="popup-report-com">
        ...
        <v-btn v-if="!reportconfirm && !banandpublication" @click="(reportconfirm = !reportconfirm), banSend()"
          id="btn-ban-confirm">
          <span>Bannir</span>
        </v-btn>
        <v-btn v-if="!reportconfirm && profilban === false && !banandpublication"
          @click="banSend(), deletedPostBan(iduserban)" id="btn-ban-and-del">
          <p id="pbandelpost">
            <span>bannir</span>
        ...
        <v-btn v-if="!reportconfirm && !banandpublication" id="btn-ban-delete" @click="$emit('close-modale-ban-delete')">
          <span>Retour</span>
        </v-btn>
      </v-card>
    </v-col>
    <v-col v-else-if="this.unban === true" class="d-flex justify-center align-center">
      <v-card class="popup-report-com">
        <p class="logo-disconnect-delete">
          <img class="logo-white" src="../static/logo/logo.png" alt="logo" />
          <span>La team SocNet</span>
    ...
    <v-col v-else class="d-flex justify-center align-center unban-user">
      <v-card class="popup-report-com-unban">
        ...
        <div id="span-report-post-signal">
          <v-btn v-if="!reportconfirm" @click="(reportconfirm = !reportconfirm), unbanSend()" id="btn-unban">
            <span>Débannir</span>
          </v-btn>
        </div>
        <v-btn v-if="!reportconfirm" id="btn-unban-delete" @click="$emit('close-modale-ban-delete')">
          <span>Retour</span>
        </v-btn>
      </v-card>
    </v-col>
