<template>
    <div class="overlay-delete">
        <v-col v-if="!reportconfirm1" class="d-flex justify-center align-center">
            <v-card class="popup-report-com">
                ...
                <p v-if="!reportconfirm1" id="span-report-post">
                    <v-icon class="img-flag">mdi-flag</v-icon>
                    supprimer {{ fullname }}
                    <v-icon class="img-flag">mdi-flag</v-icon>
                </p>
                <v-btn v-if="!reportconfirm1" @click="(reportconfirm1 = !reportconfirm1), banSend()" id="btn-ban-confirm">
                    <span>supprimer</span>
                </v-btn>
                <v-btn v-if="!reportconfirm1" id="btn-ban-delete" @click="$emit('close-modale-bandef')">
                    <span>Retour</span>
                </v-btn>
            </v-card>
        </v-col>
        <v-col v-if="reportconfirm1" class="d-flex justify-center align-center unban-user">
            <v-card class="popup-report-com-unban">
                ...
                <p v-if="reportconfirm1" id="span-report-post-2">
                    <v-icon class="img-flag">mdi-flag</v-icon>
                    {{ fullname }} est supprimé(e)
                    <v-icon class="img-flag">mdi-flag</v-icon>
                </p>
                <v-btn v-if="reportconfirm1" id="btn-unban-delete" @click="$emit('close-modale-bandef')">
                    <span>Retour</span>
                </v-btn>
            </v-card>
        </v-col>
