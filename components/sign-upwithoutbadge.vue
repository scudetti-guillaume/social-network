    ...
    <v-col class="main d-flex justify-center align-center overlaybis-signup">
      <v-col class="form-sign">
        <v-card id="logo-form" class="logo py-4 d-flex justify-center">
          <h1><span id="form-span1">Vous inscrire </span></h1>
        </v-card>
          ...
          <v-col id="logo-form2" cols="12" sm="12" md="12">
            <v-card-text>
              <form @submit.prevent class="form-container" ref="formsignup">
                ...
                <v-spacer />
                <input style="text-transform:lowercase" v-model="lastname" class="form-input" type="text" name="nom"
                ...
                <v-spacer />
                <input style="text-transform:lowercase" v-model="firstname" class="form-input" type="text"
                ...
                <input style="text-transform:lowercase" v-model="email" class="form-input" type="text"
                  placeholder="nom.prenom@socialnetwork.fr" name="email" required />
                ...
                <input id="pass" v-model="psw" name="pass" class="form-input" type="password"
                  placeholder="Votre mot de passe" required />
                <div class="rules">
                  <div class="rulespan" v-for="error in passwordValidation.errors">
                    {{ error }}
                  </div>
                </div>
                <v-spacer />
                ...
                <input id="passcom" v-model.lazy="pswcom" :disabled="!passwordValidation.valid" name="passcom"
                  class="form-input" type="password" placeholder="Comfirmer votre mot de passe" required />
                ...
                <div class="check-box">
                  ...
                  <input v-model="check" class="form-input-check" type="checkbox" name="condition" required />
                </div>
              ...
              <button id="form-span2">
                <button class="btn" id="link-sign" @click="$emit('close-modal'), reset()">
